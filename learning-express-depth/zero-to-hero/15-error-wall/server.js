...
// ===========================
// Adds a single error-handling middleware. Custom error classes map to
// status codes. Handlers throw; the wall catches. JSON responses are
// consistent. No stack traces leaked.
//
// Setup:
