...
// Project 33: The RBAC
// =====================
// Adds Role-Based Access Control. Workspaces and workspace_members tables.
// Roles: owner (4) > admin (3) > member (2) > guest (1). A user can have
// different roles in different workspaces. The requireRole middleware
// checks the user's role for the requested workspace.
//
// Setup:
//   redis-server
...
//   CREATE TABLE workspaces (id INTEGER PK, name TEXT, owner_id INTEGER REF users(id), created_at INTEGER);
//   CREATE TABLE workspace_members (workspace_id INTEGER, user_id INTEGER, role TEXT CHECK (role IN ('owner','admin','member','guest')), PRIMARY KEY (workspace_id, user_id));
...
// PROJECT 33: role hierarchy + requireRole middleware
...
// PROJECT 33: workspace endpoints
app.post(
  "/workspaces",
  authMiddleware,
