...
// ==============================
// Refactors the API to follow REST conventions. URLs are resources
// (/users, /posts, /sessions). Methods are verbs (GET, POST, PATCH, DELETE).
// Status codes are meaningful (200, 201, 204, 400, 401, 403, 404, 409).
//
// Setup:
...
app.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    req.log.info(
      { postId: id, userId: req.user.userId, title },
      "post created",
    );
