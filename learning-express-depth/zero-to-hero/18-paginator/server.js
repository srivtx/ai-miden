...
// ==========================
// Adds pagination to list endpoints. Uses offset-based pagination with
// limit and offset query parameters. Returns { data, meta } with total,
// limit, offset, page, and totalPages. Caps the limit at 100.
//
// Setup:
...
app.get('/users', asyncHandler(async (req, res) => {
  ...
  res.json({ data: users, meta: meta(count, limit, offset) });
}));
