...
// =========================
// Adds file upload with Multer. Accepts multipart/form-data, saves files
// to ./uploads with UUID names, and serves them via /uploads. Posts now
// have an image_url column.
//
// Setup:
//   rm -f app.db
