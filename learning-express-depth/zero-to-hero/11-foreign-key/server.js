...
// ===========================
// Adds a posts table with a foreign key to users. The relationship is
// enforced by the database (PRAGMA foreign_keys = ON, ON DELETE CASCADE).
// JOIN queries combine posts with their authors.
//
// Setup:
